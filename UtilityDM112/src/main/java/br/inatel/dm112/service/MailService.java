...
public class MailService
{
	...
	{
		// if (mailReq.getTo() == null || mailReq.getContent() == null)
		if (mailReq.getTo() == null)
		{
			throw new UtilityException("Null values not allowed in MailData.");
		}
		MailData mailData = new MailData(mailReq.getOrderNumber(), emailFromAddress, emailFromPassword, mailReq.getTo(), mailReq.getContent(), mailReq.getMensagem());
		// set credentials
